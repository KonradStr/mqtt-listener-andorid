...
fun BrokerListScreen() {
    ...
    LaunchedEffect(brokers) {
        brokers.forEach { broker ->
            startMqttService(context, broker)
        }
    }
...
fun startMqttService(context: Context, broker: Broker) {
    ...
    val foregroundStartIntent = Intent(context, MqttService::class.java).apply {
        action = MqttService.ACTION_START_FOREGROUND
    }
    context.startService(foregroundStartIntent)
